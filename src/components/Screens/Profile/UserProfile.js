...
const Profile = () => {
    ...
    console.log("state prfile", state);
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", width: "110%" }}>
                                    <h6>
                                        <span style={{ fontWeight: "650" }}>{userProfile.posts.length}</span> bài viết
                                    </h6>
                                    <h6>
                                        <span style={{ fontWeight: "650" }}>{userProfile.user.followers.length}</span>{" "}
                                        người theo dõi
                                    </h6>
                                    <h6>
                                        Đang theo dõi{" "}
                                        <span style={{ fontWeight: "650" }}>{userProfile.user.following.length}</span>{" "}
                                        người
                                    </h6>
                                </div>
                                {showfollow ? (
